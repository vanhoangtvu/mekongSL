...
### Frontend (.env.local)
```env
NEXT_PUBLIC_API_URL=http://113.170.158.188:8084/api
```
...
configuration.setAllowedOrigins(List.of(
    "http://localhost:3004",
    "http://localhost:3000",
    "http://113.170.158.188:3004",  // ✅ Added
    "http://113.170.158.188:3000"   // ✅ Added
));
```
...
### Test Backend
```bash
curl http://113.170.158.188:8084/api/auth/login \
  -X POST \
...
### Test Frontend
Mở browser: `http://113.170.158.188:3004`
