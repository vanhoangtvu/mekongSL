...
# Example
curl -X GET http://113.170.158.188:8084/api/s3/download/uploads/20260525_183000_file.pdf \
  -H "Authorization: Bearer <manager_token>" \
...
# Example
curl -X GET http://113.170.158.188:8084/api/s3/list?prefix=uploads/ \
  -H "Authorization: Bearer <manager_token>"
...
# Example
curl -X DELETE http://113.170.158.188:8084/api/s3/delete/uploads/20260525_183000_file.pdf \
  -H "Authorization: Bearer <manager_token>"
...
# Example
curl -X GET http://113.170.158.188:8084/api/s3/exists/uploads/20260525_183000_file.pdf \
  -H "Authorization: Bearer <manager_token>"
...
# 3. Test list
curl -X GET http://113.170.158.188:8084/api/s3/list \
  -H "Authorization: Bearer $TOKEN"
```
