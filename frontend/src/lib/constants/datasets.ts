    ...
    children: [
      {
        ...
        children: [
          { id: "baseline-landuse-plan/tra-vinh-chau-thanh", name: "Trà Vinh – Châu Thành District", slug: "tra-vinh-chau-thanh", type: "vector", timeScale: "year" },
          { id: "baseline-landuse-plan/tra-vinh-cang-long", name: "Trà Vinh – Càng Long District", slug: "tra-vinh-cang-long", type: "vector", timeScale: "year" },
          { id: "baseline-landuse-plan/tra-vinh-cau-ke", name: "Trà Vinh – Cầu Kè District", slug: "tra-vinh-cau-ke", type: "vector", timeScale: "year" },
          { id: "baseline-landuse-plan/tra-vinh-tieu-can", name: "Trà Vinh – Tiểu Cần District", slug: "tra-vinh-tieu-can", type: "vector", timeScale: "year" },
          { id: "baseline-landuse-plan/tra-vinh-cau-ngang", name: "Trà Vinh – Cầu Ngang District", slug: "tra-vinh-cau-ngang", type: "vector", timeScale: "year" },
          { id: "baseline-landuse-plan/tra-vinh-tra-cu", name: "Trà Vinh – Trà Cú District", slug: "tra-vinh-tra-cu", type: "vector", timeScale: "year" },
          { id: "baseline-landuse-plan/tra-vinh-duyen-hai", name: "Trà Vinh – Duyên Hải District", slug: "tra-vinh-duyen-hai", type: "vector", timeScale: "year" },
          { id: "baseline-landuse-plan/tra-vinh-city", name: "Trà Vinh – Trà Vinh City", slug: "tra-vinh-city", type: "vector", timeScale: "year" },
          { id: "baseline-landuse-plan/tra-vinh-duyen-hai-town", name: "Trà Vinh – Duyên Hải Town", slug: "tra-vinh-duyen-hai-town", type: "vector", timeScale: "year" },
        ],
      },
      { id: "baseline-soil", name: "Soil Type", slug: "soil-type", scale: "Province", timeScale: "year" },
      {
        ...
        scale: "Province",
        children: [
          { id: "channel-system/main-river", name: "Main River", slug: "main-river", type: "vector", timeScale: "year" },
          {
          ...
          { id: "channel-system/dike", name: "Dike", slug: "dike", type: "vector", timeScale: "year" },
          { id: "channel-system/hydraulic-works", name: "Hydraulic Works", slug: "hydraulic-works", type: "vector", timeScale: "year" },
          { id: "channel-system/bridge", name: "Bridge", slug: "bridge", type: "vector", timeScale: "year" },
          { id: "channel-system/residential", name: "Residential Area", slug: "residential", type: "vector", timeScale: "year" },
