    ...
    children: [
      ...
      { id: "baseline-soil", name: "Soil Type", slug: "soil-type", scale: "Province", timeScale: "year" },
      {
        ...
        children: [
          ...
          { id: "channel-system/bridge", name: "Cầu giao thông", slug: "bridge", timeScale: "year" },
          { id: "channel-system/residential", name: "Khu dân cư", slug: "residential", timeScale: "year" },
          { id: "channel-system/pump-station", name: "Trạm bơm", slug: "pump-station", timeScale: "year" },
        ],
      },
